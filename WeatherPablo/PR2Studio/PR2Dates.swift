...
extension String {
    ...
    /// Date format for news Items
    func PR2DateFormatterItem() -> NSDate {
        return NSDateFormatter.PR2DateFormatterItem.dateFromString(self)!
    }
...
extension NSDate {
    ...
    /// Date format for news Items
    func PR2DateFormatterItem() -> String {
        return NSDateFormatter.PR2DateFormatterItem.stringFromDate(self)
    }
...
extension NSDateFormatter {
    ...
    private static let PR2DateFormatterItem: NSDateFormatter = {
