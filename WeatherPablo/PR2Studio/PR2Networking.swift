...
public class PR2Networking {
    ...
    /**
    Recursive Request till delay > 30 seconds
...
//                NSURLCache.sharedURLCache().storeCachedResponse(cachedURLResponse, forRequest: response.request!)
    ...
    /**
    Executed before any request (activity indicator & console logger)
    ...
    */
    ...
    /**
     Executed after any request (activity indicator & console logger)
    ...
    */
    ...
    // MARK: - misc functions
    /**
    Generates user agent from Info.plist
    */
    ...
    /**
     Generates phone model (hardware)
     */
    ...
    /**
     is the request error non temporary? Then we fail and cancel any further request
